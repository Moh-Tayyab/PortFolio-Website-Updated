  ...
  return (
    ...
    <div className='py-12 bg-gray-900'>
      ...
      <div className='mt-20 text-center'>
        <Link target="_blank" href={"https://github.com/Moh-Tayyab"} className="px-4 py-2 rounded border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-100 transition duration-200">
          View All Projects
        </Link>
      </div>
    </div>
